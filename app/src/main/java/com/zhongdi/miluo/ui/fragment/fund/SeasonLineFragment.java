...
import com.zhongdi.miluo.presenter.SeasonFragPresenter;
...
public class SeasonLineFragment extends BaseFragment<SeasonFragPresenter> implements SeasonFragmentView {
    ...
    public static SeasonLineFragment newInstance(String fundcode) {
    ...
    protected SeasonFragPresenter initPresenter() {
        return new SeasonFragPresenter(this);
    }
