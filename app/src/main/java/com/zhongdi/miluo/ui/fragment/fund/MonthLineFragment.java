...
import com.zhongdi.miluo.presenter.MonthFragPresenter;
...
public class MonthLineFragment extends BaseFragment<MonthFragPresenter> implements MonthFragmentView {
    ...
    @Override
    protected MonthFragPresenter initPresenter() {
        return new MonthFragPresenter(this);
    }
