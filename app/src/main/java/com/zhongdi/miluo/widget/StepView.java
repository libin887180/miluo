...
public class StepView extends View {
    ...
    public StepView(Context context, AttributeSet attrs) {
        ...
        mSelectedTextColor = ta.getColor(R.styleable.StepView_svSelectedTextColor, 0);
        svStepNumColor = ta.getColor(R.styleable.StepView_svStepNumColor, 0);
        mLineColor = ta.getColor(R.styleable.StepView_svLineColor, 0);
...
//            canvas.drawCircle(circleCenterX, circleCenterY, mFillRadius, mPaint);
            ...
            mPaint.setColor(svStepNumColor);
        ...
        mPaint.setColor(isSelected ? mSelectedTextColor : mTextColor);
