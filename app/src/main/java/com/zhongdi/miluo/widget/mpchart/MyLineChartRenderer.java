...
public class MyLineChartRenderer extends LineRadarRenderer {
    ...
    private int highlighCirclecolor;
    private float highlightCircleRadius;
    private float highlightCircleStrokeWidth;
    /**
    ...
    protected void drawHighlightLines(Canvas c, float x, float y, ILineScatterCandleRadarDataSet set) {
        mHighlightPaint.setColor(set.getColor(0));
        mHighlightPaint.setStrokeWidth(set.getHighlightLineWidth() * 3);
        c.drawCircle(x, y, 10f, mHighlightPaint);
        ...
        if (set.isVerticalHighlightIndicatorEnabled()) {
            ...
            mHighlightLinePath.lineTo(x, y - 15f);
            mHighlightLinePath.moveTo(x, y + 15f);
        ...
        if (set.isHorizontalHighlightIndicatorEnabled()) {
            ...
            mHighlightLinePath.lineTo(x - 15f, y);

            mHighlightLinePath.moveTo(x + 15f, y);
