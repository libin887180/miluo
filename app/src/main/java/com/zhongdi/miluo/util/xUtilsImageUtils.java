...
public class xUtilsImageUtils {
     ...
     * @param iconUrl   图片地址
     */
    public static void display(ImageView imageView, String iconUrl,int failureId,int loadingId) {
        ImageOptions imageOptions = new ImageOptions.Builder()
                .setIgnoreGif(false)//是否忽略gif图。false表示不忽略。不写这句，默认是true
                .setImageScaleType(ImageView.ScaleType.CENTER_CROP)
                .setFailureDrawableId(failureId)
     ...
     */
    public static void display(ImageView imageView, String iconUrl, boolean isCircluar,int failureId,int loadingId) {
        ImageOptions imageOptions = new ImageOptions.Builder()
                .setImageScaleType(ImageView.ScaleType.CENTER_INSIDE)
                .setCircular(isCircluar)
                .setCrop(true)
                .setLoadingDrawableId(failureId)
                .setFailureDrawableId(loadingId)
                .build();
        x.image().bind(imageView, iconUrl, imageOptions);
    }
}